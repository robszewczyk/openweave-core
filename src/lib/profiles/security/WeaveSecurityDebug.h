...
extern void PrintCert(FILE * out, const WeaveCertificateData & cert, const WeaveCertificateSet * certSet, uint16_t indent = 0,
                      bool verbose = false);
extern void PrintCertValidationResults(FILE * out, const WeaveCertificateSet & certSet, const ValidationContext & validContext,
                                       uint16_t indent = 0);
