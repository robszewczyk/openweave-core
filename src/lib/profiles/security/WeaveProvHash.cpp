 ...
 *                                      value.
 */
NL_DLL_EXPORT WEAVE_ERROR MakeWeaveProvisioningHash(uint64_t nodeId, const char * weaveCert, size_t weaveCertLen,
                                                    const char * weavePrivKey, size_t weavePrivKeyLen, const char * pairingCode,
                                                    size_t pairingCodeLen, char * hashBuf, size_t hashBufSize)
{
 ...
 *                                      value.
 */
NL_DLL_EXPORT WEAVE_ERROR MakeDeviceCredentialHash(const char * serialNum, size_t serialNumLen, const char * deviceId,
