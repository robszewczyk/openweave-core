...
public:
    ...
    virtual WEAVE_ERROR GetNextIdentificationKey(uint64_t & tokenId, uint8_t * identificationKey,
    ...
    virtual WEAVE_ERROR GetTokenAuthData(uint64_t tokenId, uint8_t & takeConfig, uint8_t * authKey, uint16_t & authKeyLen,
    ...
    virtual WEAVE_ERROR StoreTokenAuthData(uint64_t tokenId, uint8_t takeConfig, const uint8_t * authKey, uint16_t authKeyLen,
...
public:
    ...
    // First handshake.
    WEAVE_ERROR GenerateIdentifyTokenMessage(uint16_t sessionKeyId, uint8_t takeConfig, bool encryptAuthPhase,
...
private:
    ...
    WEAVE_ERROR GenerateAuthenticationKey(const uint8_t * challengerId, uint8_t * privateKey, uint8_t * publicKey,
                                          uint16_t privateKeyLen);

    WEAVE_ERROR GenerateSignatureForAuthenticateTokenResponse(uint8_t * dest, const uint8_t * challengerECDHPublicKey,
                                                              const uint8_t * tokenECDHPublicKey, EncodedECPrivateKey TPriv,
                                                              const uint8_t * encryptedState, OID & curveOID);
    WEAVE_ERROR VerifySignatureForAuthenticateTokenResponse(const uint8_t * signature, const uint8_t * challengerECDHPublicKey,
