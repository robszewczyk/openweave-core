...
public:
    ...
    WEAVE_ERROR GenerateKeyExportRequest(uint32_t keyId, uint64_t responderNodeId, const uint8_t * clientCert,
                                         uint16_t clientCertLen, const uint8_t * clientKey, uint16_t clientKeyLen, uint8_t * reqBuf,
                                         uint16_t reqBufSize, uint16_t & reqLen);

    WEAVE_ERROR GenerateKeyExportRequest(uint32_t keyId, uint64_t responderNodeId, const uint8_t * accessToken,
