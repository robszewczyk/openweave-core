...
WEAVE_ERROR UpdateClient::SendUpdate(bool aIsPartialUpdate, PacketBuffer * aBuf, bool aIsFirstPayload)
{
    ...
    WEAVE_FAULT_INJECT(FaultInjection::kFault_WDM_UpdateRequestSendErrorInline,
                       nl::Inet::FaultInjection::GetManager().FailAtFault(nl::Inet::FaultInjection::kFault_Send, 0, 1));
    ...
    WEAVE_FAULT_INJECT(
        FaultInjection::kFault_WDM_UpdateRequestDropMessage,
        nl::Inet::FaultInjection::GetManager().FailAtFault(nl::Weave::FaultInjection::kFault_DropOutgoingUDPMsg, 0, 1));

    // Use WRM's SendError fault to fail asynchronously
#if WEAVE_CONFIG_ENABLE_RELIABLE_MESSAGING
    WEAVE_FAULT_INJECT(FaultInjection::kFault_WDM_UpdateRequestSendErrorAsync,
                       nl::Weave::FaultInjection::GetManager().FailAtFault(nl::Weave::FaultInjection::kFault_WRMSendError, 0, 1));
    ...
    WEAVE_FAULT_INJECT(
        FaultInjection::kFault_WDM_DelayUpdateResponse,
        nl::Weave::FaultInjection::GetManager().FailAtFault(nl::Weave::FaultInjection::kFault_DropIncomingUDPMsg, 0, 1));
...
void UpdateClient::DefaultEventHandler(void * apAppState, EventType aEvent, const InEventParam & aInParam,
...
const char * UpdateClient::GetStateStr() const
{
    switch (mState)
    {
    case kState_Uninitialized: return "Uninitialized";

    case kState_Initialized: return "Initialized";

    case kState_AwaitingResponse: return "AwaitingResponse";
    }
    return "N/A";
}
