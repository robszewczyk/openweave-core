...
private:
    ...
    static void
    DNSResultEventHandler(Weave::System::Layer * aLayer, void * aAppState,
                          Weave::System::Error aError); /* Timer event handler function for asynchronous DNS notification */
