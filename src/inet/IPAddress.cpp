...
IPAddress IPAddress::FromLwIPAddr(const ip_addr_t & addr)
{
    ...
    {
#if INET_CONFIG_ENABLE_IPV4
    case IPADDR_TYPE_V4: ret = IPAddress::FromIPv4(*ip_2_ip4(&addr)); break;
#endif // INET_CONFIG_ENABLE_IPV4

    case IPADDR_TYPE_V6: ret = IPAddress::FromIPv6(*ip_2_ip6(&addr)); break;
...
lwip_ip_addr_type IPAddress::ToLwIPAddrType(IPAddressType typ)
{
    ...
    {
#if INET_CONFIG_ENABLE_IPV4
    case kIPAddressType_IPv4: ret = IPADDR_TYPE_V4; break;
#endif // INET_CONFIG_ENABLE_IPV4

    case kIPAddressType_IPv6: ret = IPADDR_TYPE_V6; break;

    default: ret = IPADDR_TYPE_ANY; break;
    }
