...
INET_ERROR RawEndPoint::GetPCB(IPAddressType addrType)
{
    ...
    if (mRaw == NULL)
    {
        ...
        default: lRetval = INET_ERROR_WRONG_ADDRESS_TYPE; goto exit;
        }
    ...
    else
    {
        ...
        {
        case IPADDR_TYPE_V6: VerifyOrExit(addrType == kIPAddressType_IPv6, lRetval = INET_ERROR_WRONG_ADDRESS_TYPE); break;

#if INET_CONFIG_ENABLE_IPV4
        case IPADDR_TYPE_V4: VerifyOrExit(addrType == kIPAddressType_IPv4, lRetval = INET_ERROR_WRONG_ADDRESS_TYPE); break;
#endif // INET_CONFIG_ENABLE_IPV4
...
INET_ERROR RawEndPoint::GetSocket(IPAddressType aAddressType)
{
    ...
    switch (aAddressType)
    {
    case kIPAddressType_IPv6: lProtocol = IPPROTO_ICMPV6; break;

#if INET_CONFIG_ENABLE_IPV4
    case kIPAddressType_IPv4: lProtocol = IPPROTO_ICMP; break;
#endif // INET_CONFIG_ENABLE_IPV4
