                                                     ...
                                                     uintptr_t aArgument)
{
    ...
    case kInetEvent_TCPDataSent: static_cast<TCPEndPoint &>(aTarget).HandleDataSent(static_cast<uint16_t>(aArgument)); break;

    case kInetEvent_TCPError: static_cast<TCPEndPoint &>(aTarget).HandleError(static_cast<INET_ERROR>(aArgument)); break;
#endif // INET_CONFIG_ENABLE_TCP_ENDPOINT
...
#if INET_CONFIG_ENABLE_DNS_RESOLVER
    case kInetEvent_DNSResolveComplete: static_cast<DNSResolver &>(aTarget).HandleResolveComplete(); break;
#endif // INET_CONFIG_ENABLE_DNS_RESOLVER

    default: lReturn = WEAVE_SYSTEM_ERROR_UNEXPECTED_EVENT; ExitNow();
    }
                     ...
                     uintptr_t aArgument)
{
    ...
    Weave::System::Error lReturn =
        Weave::System::Platform::Layer::PostEvent(lSystemLayer, aContext, lObject, aEventType, aArgument);
