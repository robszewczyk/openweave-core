...
static const nlTest sTests[] = {
    ...
    NL_TEST_DEF("WeaveFabricState::SelectNodeAddress", CheckSelectNodeAddressWithSubnet), NL_TEST_SENTINEL()
};

int main(void)
{
    nlTestSuite theSuite = { "weave-fabric-state", &sTests[0], TestSetup, TestTeardown
