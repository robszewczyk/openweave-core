 ...
 */
static const nlTest sTests[] = { NL_TEST_DEF("Timer::TestOverflow", CheckOverflow),
                                 NL_TEST_DEF("Timer::TestTimerStarvation", CheckStarvation), NL_TEST_SENTINEL() };

static int TestSetup(void * aContext);
static int TestTeardown(void * aContext);

static nlTestSuite kTheSuite = { "weave-system-timer", &sTests[0], TestSetup, TestTeardown };
