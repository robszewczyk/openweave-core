...
static void Check_HMACSHA1_Test1(nlTestSuite * inSuite, void * inContext)
{
    ...
    static uint8_t Key[]            = { 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b,
                             0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b };
    static uint8_t Data[]           = "Hi There";
    static uint8_t ExpectedDigest[] = { 0xb6, 0x17, 0x31, 0x86, 0x55, 0x05, 0x72, 0x64, 0xe2, 0x8b,
...
static void Check_HMACSHA1_Test2(nlTestSuite * inSuite, void * inContext)
{
    ...
    static uint8_t Key[]  = { 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                             0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa };
    static uint8_t Data[] = { 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd,
                              0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd,
                              0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd };
    static uint8_t ExpectedDigest[] = { 0x12, 0x5d, 0x73, 0x42, 0xb9, 0xac, 0x11, 0xcd, 0x91, 0xa3,
...
static const nlTest sTests[] = { NL_TEST_DEF("HMACSHA1 Test1", Check_HMACSHA1_Test1),
                                 NL_TEST_DEF("HMACSHA1 Test2", Check_HMACSHA1_Test2), NL_TEST_SENTINEL() };

int WeaveCryptoHMACTests(void)
{
    nlTestSuite theSuite = { "Weave Crypto HMACSHA1 Tests", &sTests[0] };
