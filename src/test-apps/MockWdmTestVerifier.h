...
uint16_t DumpClientTraitChecksum(const nl::Weave::Profiles::DataManagement::TraitSchemaEngine * inSchemaEngine,
                                 nl::Weave::Profiles::DataManagement::TraitSchemaEngine::IGetDataDelegate *);
