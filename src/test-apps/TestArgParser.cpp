...
static OptionDef sOptionSetA_Defs[] = {
    { "foo", kNoArgument, '1' }, { "bar", kNoArgument, 1001 }, { "baz", kArgumentRequired, 'Z' }, { }
};

static OptionSet sOptionSetA = { HandleOption, sOptionSetA_Defs, "OPTION SET A",
...
static OptionDef sOptionSetB_Defs[] = {
    { "stop", kNoArgument, 's' }, { "run", kArgumentRequired, 1000 }, { "walk", kNoArgument, 1001 }, { }
};

static OptionSet sOptionSetB = { HandleOption, sOptionSetB_Defs, "OPTION SET B",
...
static void SimpleParseTest_SingleLongOption()
{
    ...
    static const char * argv[]      = { "", "--foo", NULL };
...
static void SimpleParseTest_SingleLongOptionWithValue()
{
    ...
    static OptionSet * optionSets[] = { &sOptionSetA, &sOptionSetB, NULL };
    static const char * argv[]      = { "", "--run", "run-value", NULL };
    static int argc                 = sizeof(argv) / sizeof(argv[0]) - 1;
...
static void SimpleParseTest_SingleShortOptionWithValue()
{
    ...
    static OptionSet * optionSets[] = { &sOptionSetA, &sOptionSetB, NULL };
    static const char * argv[]      = { "", "-Z", "baz-value", NULL };
    static int argc                 = sizeof(argv) / sizeof(argv[0]) - 1;
...
static void UnknownOptionTest_UnknownShortOption()
{
    ...
    static const char * argv[]      = { "",      "--foo",         "--run", "run-value",
                                   "-q", // <-- unknown option -q
                                   "--bar", "non-opt-arg-1", NULL };
    static int argc                 = sizeof(argv) / sizeof(argv[0]) - 1;
...
static void UnknownOptionTest_UnknownShortOptionAfterArgs()
{
    ...
    static OptionSet * optionSets[] = { &sOptionSetA, &sOptionSetB, NULL };
    static const char * argv[]      = { "", "non-opt-arg-1", "non-opt-arg-2",
                                   "-Q", // <-- unknown option -Q
                                   NULL };
    static int argc                 = sizeof(argv) / sizeof(argv[0]) - 1;
...
static void MissingValueTest_MissingLongOptionValue()
{
    ...
    static OptionSet * optionSets[] = { &sOptionSetA, &sOptionSetB, NULL };
    static const char * argv[]      = { "", "--run", NULL };
    static int argc                 = sizeof(argv) / sizeof(argv[0]) - 1;
...
static bool HandleNonOptionArgs(const char * progName, int argc, char * argv[])
{
    ...
    printf("HandleNonOptionArgs called: progName:%s argc:%d argv[0]:%s argv[1]:%s argv[2]:%s argv[3]:%s \n", progName, argc,
           (argc > 0) ? argv[0] : "(n/a)", (argc > 1) ? argv[1] : "(n/a)", (argc > 2) ? argv[2] : "(n/a)",
           (argc > 3) ? argv[3] : "(n/a)");
#endif
