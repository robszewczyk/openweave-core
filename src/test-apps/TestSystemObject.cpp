...
private:
    ...
    {
        kPoolSize = 122
    }; // a multiple of kNumThreads, less than WEAVE_SYS_STATS_COUNT_MAX
 ...
 */
const nlTest sTests[] = { NL_TEST_DEF("Retention", TestObject::CheckRetention),
                          NL_TEST_DEF("Concurrency", TestObject::CheckConcurrency),
                          NL_TEST_DEF("HighWatermark", TestObject::CheckHighWatermark),
                          NL_TEST_DEF("HighWatermarkConcurrency", TestObject::CheckHighWatermarkConcurrency), NL_TEST_SENTINEL() };
...
nlTestSuite kTheSuite = { "weave-system-object", &sTests[0], Initialize, Finalize };
