...
MockTraitDataSink::MockTraitDataSink(const TraitSchemaEngine * aEngine) : TraitDataSink(aEngine) { }

#if WEAVE_CONFIG_ENABLE_WDM_UPDATE
MockTraitUpdatableDataSink::MockTraitUpdatableDataSink(const TraitSchemaEngine * aEngine) : TraitUpdatableDataSink(aEngine) { }
#endif // WEAVE_CONFIG_ENABLE_WDM_UPDATE

WEAVE_ERROR
MockTraitDataSourceDelegate::GetData(PropertyPathHandle aHandle, uint64_t aTagToWrite, nl::Weave::TLV::TLVWriter & aWriter,
...
LocaleSettingsTraitDataSink::LocaleSettingsTraitDataSink() : MockTraitDataSink(&LocaleSettingsTrait::TraitSchema)
{
...
WEAVE_ERROR LocaleSettingsTraitDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
...
LocaleCapabilitiesTraitDataSink::LocaleCapabilitiesTraitDataSink() :
    MockTraitDataSink(&LocaleCapabilitiesTrait::TraitSchema), mNumLocales(0)
{
...
WEAVE_ERROR LocaleCapabilitiesTraitDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                                      PropertyDictionaryKey & aKey)
{
    return WEAVE_END_OF_INPUT;
}

BoltLockSettingTraitDataSink::BoltLockSettingTraitDataSink() : MockTraitDataSink(&BoltLockSettingTrait::TraitSchema)
{
    mAutoRelockOn       = false;
...
BoltLockSettingTraitDataSink::SetLeafData(PropertyPathHandle aLeafHandle, TLVReader & aReader)
{
    ...
    case BoltLockSettingTrait::kPropertyHandle_auto_relock_on:
        ...
        {
            WeaveLogDetail(DataManagement, "<<  auto_relock_on is changed from %s to %s", mAutoRelockOn ? "true" : "false",
                           next_autoRelockOn ? "true" : "false");
    ...
    case BoltLockSettingTrait::kPropertyHandle_auto_relock_duration:
        ...
        {
            WeaveLogDetail(DataManagement, "<<  auto_relock_duration is changed from %u to %u", mAutoRelockDuration,
                           aAutoRelockDuration);
...
WEAVE_ERROR BoltLockSettingTraitDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                                   PropertyDictionaryKey & aKey)
{
    return WEAVE_END_OF_INPUT;
}

TestATraitDataSink::TestATraitDataSink() : MockTraitDataSink(&TestATrait::TraitSchema)
{
...
TestATraitDataSink::TestATraitDataSink(bool aAcceptsSublessNotifies) : MockTraitDataSink(&TestATrait::TraitSchema)
{
    TestATraitDataSink();
...
TestATraitDataSink::OnEvent(uint16_t aType, void * aInParam)
{
    ...
    case kEventDictionaryItemModifyEnd:
        WeaveLogDetail(DataManagement, "TestATraitDataSink::OnEvent event: %u (handle: %08x)", aType,
                       *(PropertyPathHandle *) aInParam);
        break;

    default: WeaveLogDetail(DataManagement, "TestATraitDataSink::OnEvent event: %u", aType);
    }
...
WEAVE_ERROR TestATraitDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                         PropertyDictionaryKey & aKey)
{
...
WEAVE_ERROR TestATraitDataSink::GetData(PropertyPathHandle aHandle, uint64_t aTagToWrite, TLVWriter & aWriter, bool & aIsNull,
                                        bool & aIsPresent)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
WEAVE_ERROR TestATraitDataSink::GetLeafData(PropertyPathHandle aLeafHandle, uint64_t aTagToWrite, TLVWriter & aWriter)
{
    ...
    default: WeaveLogDetail(DataManagement, ">>  TestATrait UNKNOWN! %08x", aLeafHandle);
    }
...
WEAVE_ERROR TestBTraitDataSink::GetData(PropertyPathHandle aHandle, uint64_t aTagToWrite, TLVWriter & aWriter, bool & aIsNull,
                                        bool & aIsPresent)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
WEAVE_ERROR TestBTraitDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                         PropertyDictionaryKey & aKey)
{
    return WEAVE_END_OF_INPUT;
}

TestBTraitDataSink::TestBTraitDataSink() : MockTraitDataSink(&TestBTrait::TraitSchema)
{
    taa     = TestATrait::ENUM_A_VALUE_1;
    tab     = TestCommon::COMMON_ENUM_A_VALUE_1;
    tac     = 0;
...
TestBTraitDataSink::SetLeafData(PropertyPathHandle aLeafHandle, TLVReader & aReader)
{
    ...
    default: WeaveLogDetail(DataManagement, "<<  TestBTrait UNKNOWN! %08x", aLeafHandle);
    }
...
WEAVE_ERROR TestApplicationKeysTraitDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                                       PropertyDictionaryKey & aKey)
{
    return WEAVE_END_OF_INPUT;
}
                                                         ...
                                                         MockWdmNodeOptions::WdmUpdateMutation aMutation)
{
    ...
    switch (aMutation)
    {
    case MockWdmNodeOptions::kMutation_Root: pathHandle = LocaleSettingsTrait::kPropertyHandle_Root; break;
...
exit:
    WeaveLogDetail(DataManagement, "LocaleSettingsTrait mutated %s with error %d",
                   MockWdmNodeOptions::GetMutationStrings()[aMutation], err);
...
WEAVE_ERROR LocaleSettingsTraitUpdatableDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle,
                                                                           uintptr_t & aContext, PropertyDictionaryKey & aKey)
{
    return WEAVE_END_OF_INPUT;
}
                                                ...
                                                MockWdmNodeOptions::WdmUpdateMutation aMutation)
{
    ...
    WeaveLogDetail(DataManagement, "TestATraitUpdatableDataSink: mTraitTestSet: %" PRIu32 ", mTestCounter: %" PRIu32 "",
...
TestATraitUpdatableDataSink::TestATraitUpdatableDataSink() : MockTraitUpdatableDataSink(&TestATrait::TraitSchema)
{
    taa     = TestATrait::ENUM_A_VALUE_1;
    tab     = TestCommon::COMMON_ENUM_A_VALUE_1;
    tac     = 0;
...
TestATraitUpdatableDataSink::OnEvent(uint16_t aType, void * aInParam)
{
    ...
    case kEventDictionaryItemModifyBegin:
    case kEventDictionaryItemModifyEnd:
        WeaveLogDetail(DataManagement, "TestATraitUpdatableDataSink::OnEvent event: %u (handle: %08x)", aType,
                       *(PropertyPathHandle *) aInParam);
        break;

    default: WeaveLogDetail(DataManagement, "TestATraitUpdatableDataSink::OnEvent event: %u", aType);
    }
...
WEAVE_ERROR TestATraitUpdatableDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                                  PropertyDictionaryKey & aKey)
{
    static std::map<uint16_t, uint32_t>::iterator tai_iter;
    static std::map<uint16_t, TestATrait::StructA>::iterator taj_iter;
...
WEAVE_ERROR TestATraitUpdatableDataSink::GetData(PropertyPathHandle aHandle, uint64_t aTagToWrite, TLVWriter & aWriter,
                                                 bool & aIsNull, bool & aIsPresent)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
TestBTraitUpdatableDataSink::TestBTraitUpdatableDataSink() : MockTraitUpdatableDataSink(&TestBTrait::TraitSchema)
{
    taa     = TestATrait::ENUM_A_VALUE_1;
    tab     = TestCommon::COMMON_ENUM_A_VALUE_1;
    tac     = 0;
...
WEAVE_ERROR TestBTraitUpdatableDataSink::GetData(PropertyPathHandle aHandle, uint64_t aTagToWrite, TLVWriter & aWriter,
                                                 bool & aIsNull, bool & aIsPresent)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
WEAVE_ERROR TestBTraitUpdatableDataSink::GetNextDictionaryItemKey(PropertyPathHandle aDictionaryHandle, uintptr_t & aContext,
                                                                  PropertyDictionaryKey & aKey)
{
    return WEAVE_END_OF_INPUT;
}
