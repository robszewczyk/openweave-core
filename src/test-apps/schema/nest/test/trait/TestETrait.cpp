...
const nl::FieldDescriptor TestEEventFieldDescriptors[] = {
    ...
    { &Schema::Nest::Test::Trait::TestETrait::StructE::FieldSchema, offsetof(TestEEvent, teE),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 5 },

    { NULL, offsetof(TestEEvent, teF), SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeInt32, 0), 6 },

    { &Schema::Nest::Test::Trait::TestCommon::CommonStructE::FieldSchema, offsetof(TestEEvent, teG),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 7 },

    { NULL, offsetof(TestEEvent, teH) + offsetof(nl::SerializedFieldTypeUInt32_array, num),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeArray, 0), 8 },
    { NULL, offsetof(TestEEvent, teH) + offsetof(nl::SerializedFieldTypeUInt32_array, buf),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeUInt32, 0), 8 },

    { NULL, offsetof(TestEEvent, teI) + offsetof(Schema::Nest::Test::Trait::TestCommon::CommonStructE_array, num),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeArray, 0), 9 },
    { &Schema::Nest::Test::Trait::TestCommon::CommonStructE::FieldSchema,
      offsetof(TestEEvent, teI) + offsetof(Schema::Nest::Test::Trait::TestCommon::CommonStructE_array, buf),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 9 },
...
const nl::SchemaFieldDescriptor TestEEvent::FieldSchema = { .mNumFieldDescriptorElements = sizeof(TestEEventFieldDescriptors) /
                                                                sizeof(TestEEventFieldDescriptors[0]),
...
const nl::FieldDescriptor TestENullableEventFieldDescriptors[] = {
    ...
    { &Schema::Nest::Test::Trait::TestETrait::NullableE::FieldSchema, offsetof(TestENullableEvent, neJ),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 1), 10 },
...
const nl::SchemaFieldDescriptor TestEEmptyEvent::FieldSchema = { .mNumFieldDescriptorElements = 0,
                                                                 .mFields                     = NULL,
...
const nl::SchemaFieldDescriptor StructE::FieldSchema = { .mNumFieldDescriptorElements =
                                                             sizeof(StructEFieldDescriptors) / sizeof(StructEFieldDescriptors[0]),
...
const nl::SchemaFieldDescriptor NullableE::FieldSchema = { .mNumFieldDescriptorElements = sizeof(NullableEFieldDescriptors) /
                                                               sizeof(NullableEFieldDescriptors[0]),
