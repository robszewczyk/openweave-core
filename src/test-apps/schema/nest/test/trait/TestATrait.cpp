...
uint8_t IsDictionaryTypeHandleBitfield[] = { 0x0, 0x6, 0x0, 0x0 };

//
// IsOptional Table
//

uint8_t IsOptionalHandleBitfield[] = { 0x4, 0x0, 0x0, 0x0 };

//
// IsNullable Table
//

uint8_t IsNullableHandleBitfield[] = { 0x18, 0x60, 0xf9, 0x9 };

//
// IsEphemeral Table
//

uint8_t IsEphemeralHandleBitfield[] = { 0x18, 0x0, 0x10, 0x8 };
...
const nl::SchemaFieldDescriptor StructA::FieldSchema = { .mNumFieldDescriptorElements =
                                                             sizeof(StructAFieldDescriptors) / sizeof(StructAFieldDescriptors[0]),
