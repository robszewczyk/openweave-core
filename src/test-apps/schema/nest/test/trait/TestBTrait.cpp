...
uint8_t IsDictionaryTypeHandleBitfield[] = { 0x0, 0x6, 0x0, 0x0, 0x0 };

//
// IsOptional Table
//

uint8_t IsOptionalHandleBitfield[] = { 0x4, 0x0, 0x0, 0x0, 0x0 };

//
// IsNullable Table
//

uint8_t IsNullableHandleBitfield[] = { 0x18, 0x60, 0xf9, 0x41, 0x8 };

//
// IsEphemeral Table
//

uint8_t IsEphemeralHandleBitfield[] = { 0x18, 0x0, 0x10, 0x40, 0x8 };
...
const nl::SchemaFieldDescriptor StructB::FieldSchema = { .mNumFieldDescriptorElements =
                                                             sizeof(StructBFieldDescriptors) / sizeof(StructBFieldDescriptors[0]),
...
const nl::SchemaFieldDescriptor StructEA::FieldSchema = { .mNumFieldDescriptorElements = sizeof(StructEAFieldDescriptors) /
                                                              sizeof(StructEAFieldDescriptors[0]),
