...
uint8_t IsDictionaryTypeHandleBitfield[] = { 0x0, 0x48, 0x0 };
...
const nl::SchemaFieldDescriptor StructH::FieldSchema = { .mNumFieldDescriptorElements =
                                                             sizeof(StructHFieldDescriptors) / sizeof(StructHFieldDescriptors[0]),
