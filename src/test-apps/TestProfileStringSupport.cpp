...
static const struct Support::ProfileStringInfo sTestProfileStringInfo_1 = { kWeaveProfile_TestProfileStringSupport_1,
                                                                            TestMessageStrFunct, TestProfileStrFunct,
                                                                            TestStatusReportStrFunct };

static struct Support::ProfileStringContext sTestProfileStringContext_1 = { NULL, sTestProfileStringInfo_1 };

static const struct Support::ProfileStringInfo sTestProfileStringInfo_2 = { kWeaveProfile_TestProfileStringSupport_2, NULL, NULL,
                                                                            NULL };

static struct Support::ProfileStringContext sTestProfileStringContext_2 = { NULL, sTestProfileStringInfo_2 };

static const struct Support::ProfileStringInfo sTestProfileStringInfo_3 = { kWeaveProfile_TestProfileStringSupport_3, NULL, NULL,
                                                                            NULL };

static struct Support::ProfileStringContext sTestProfileStringContext_3 = { NULL, sTestProfileStringInfo_3 };

static struct Support::ProfileStringContext sTestProfileStringContext_1_Alias = { NULL, sTestProfileStringInfo_1 };

static struct Support::ProfileStringContext sTestProfileStringContext_2_Alias = { NULL, sTestProfileStringInfo_2 };

static struct Support::ProfileStringContext sTestProfileStringContext_3_Alias = { NULL, sTestProfileStringInfo_3 };
...
{
    Support::ProfileStringContext * contexts[3] = { &sTestProfileStringContext_1, &sTestProfileStringContext_2,
                                                    &sTestProfileStringContext_3 };
    Support::ProfileStringContext * aliases[3]  = { &sTestProfileStringContext_1_Alias, &sTestProfileStringContext_2_Alias,
...
{
    Support::ProfileStringContext * contexts[3] = { &sTestProfileStringContext_1, &sTestProfileStringContext_3,
                                                    &sTestProfileStringContext_2 };
    Support::ProfileStringContext * aliases[3]  = { &sTestProfileStringContext_1_Alias, &sTestProfileStringContext_3_Alias,
...
{
    Support::ProfileStringContext * contexts[3] = { &sTestProfileStringContext_2, &sTestProfileStringContext_1,
                                                    &sTestProfileStringContext_3 };
    Support::ProfileStringContext * aliases[3]  = { &sTestProfileStringContext_2_Alias, &sTestProfileStringContext_1_Alias,
                                                   &sTestProfileStringContext_3_Alias };
    ProfileStringRegisterParams params          = {
        { contexts, sizeof(contexts) / sizeof(contexts[0]) },
        { aliases, sizeof(aliases) / sizeof(aliases[0]) },
...
{
    Support::ProfileStringContext * contexts[3] = { &sTestProfileStringContext_2, &sTestProfileStringContext_3,
                                                    &sTestProfileStringContext_1 };
    Support::ProfileStringContext * aliases[3]  = { &sTestProfileStringContext_2_Alias, &sTestProfileStringContext_3_Alias,
...
{
    Support::ProfileStringContext * contexts[3] = { &sTestProfileStringContext_3, &sTestProfileStringContext_2,
                                                    &sTestProfileStringContext_1 };
    Support::ProfileStringContext * aliases[3]  = { &sTestProfileStringContext_3_Alias, &sTestProfileStringContext_2_Alias,
                                                   &sTestProfileStringContext_1_Alias };
    ProfileStringRegisterParams params          = {
        { contexts, sizeof(contexts) / sizeof(contexts[0]) },
        { aliases, sizeof(aliases) / sizeof(aliases[0]) },
...
static const nlTest sTests[] = {
    NL_TEST_DEF("unregister (empty)", CheckUnregisterEmpty),        NL_TEST_DEF("find (empty)", CheckFindEmpty),
    NL_TEST_DEF("register 1-2-3 (empty)", CheckRegisterEmpty_123),  NL_TEST_DEF("find and unregister", CheckFindAndUnregister),
    NL_TEST_DEF("register 1-3-2 (empty)", CheckRegisterEmpty_132),  NL_TEST_DEF("find and unregister", CheckFindAndUnregister),
    NL_TEST_DEF("register 2-1-3 (empty)", CheckRegisterEmpty_213),  NL_TEST_DEF("find and unregister", CheckFindAndUnregister),
    NL_TEST_DEF("register 2-3-1 (empty)", CheckRegisterEmpty_231),  NL_TEST_DEF("find and unregister", CheckFindAndUnregister),
    NL_TEST_DEF("register 3-1-2 (empty)", CheckRegisterEmpty_312),  NL_TEST_DEF("find and unregister", CheckFindAndUnregister),
    NL_TEST_DEF("register 3-2-1 (empty)", CheckRegisterEmpty_321),  NL_TEST_DEF("find and unregister", CheckFindAndUnregister),
    NL_TEST_DEF("unregister with alias", CheckUnregisterWithAlias), NL_TEST_SENTINEL()
};

int main(void)
{
    nlTestSuite theSuite = { "weave-profile-string-support", &sTests[0] };
