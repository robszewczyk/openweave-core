...
const nl::FieldDescriptor TelemetryTunnelStatsEventFieldDescriptors[] = {
    ...
    { NULL, offsetof(TelemetryTunnelStatsEvent, lastTimeTunnelEstablished), SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeInt64, 0),
      8 },
...
const nl::SchemaFieldDescriptor TelemetryTunnelStatsEvent::FieldSchema                   = { .mNumFieldDescriptorElements =
                                                                               sizeof(TelemetryTunnelStatsEventFieldDescriptors) /
                                                                               sizeof(TelemetryTunnelStatsEventFieldDescriptors[0]),
