...
uint8_t IsOptionalHandleBitfield[] = { 0x8e, 0x7 };

//
// IsNullable Table
//

uint8_t IsNullableHandleBitfield[] = { 0xe, 0x7 };
...
const nl::FieldDescriptor BatteryChangedEventFieldDescriptors[] = {
    ...
    { &Schema::Weave::Trait::Power::BatteryPowerSourceTrait::BatteryRemaining::FieldSchema,
      offsetof(BatteryChangedEvent, remaining), SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 17 },
...
const nl::FieldDescriptor BatteryRemainingFieldDescriptors[] = {
    ...
    { &Schema::Weave::Common::Timer::FieldSchema, offsetof(BatteryRemaining, remainingTime),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 1), 2 },
