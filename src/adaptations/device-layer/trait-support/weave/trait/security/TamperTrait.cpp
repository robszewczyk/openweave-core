...
uint8_t IsEphemeralHandleBitfield[] = { 0x4 };
...
const nl::SchemaFieldDescriptor TamperStateChangeEvent::FieldSchema                   = { .mNumFieldDescriptorElements =
                                                                            sizeof(TamperStateChangeEventFieldDescriptors) /
                                                                            sizeof(TamperStateChangeEventFieldDescriptors[0]),
