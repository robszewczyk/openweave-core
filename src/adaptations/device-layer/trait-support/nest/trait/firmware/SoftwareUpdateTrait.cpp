...
const nl::SchemaFieldDescriptor SoftwareUpdateStartEvent::FieldSchema                   = { .mNumFieldDescriptorElements =
                                                                              sizeof(SoftwareUpdateStartEventFieldDescriptors) /
                                                                              sizeof(SoftwareUpdateStartEventFieldDescriptors[0]),
...
const nl::FieldDescriptor FailureEventFieldDescriptors[] = {
    ...
    { &Schema::Weave::Common::ProfileSpecificStatusCode::FieldSchema, offsetof(FailureEvent, primaryStatusCode),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 1), 3 },

    { &Schema::Weave::Common::ProfileSpecificStatusCode::FieldSchema, offsetof(FailureEvent, remoteStatusCode),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 1), 4 },

};

const nl::SchemaFieldDescriptor FailureEvent::FieldSchema = { .mNumFieldDescriptorElements = sizeof(FailureEventFieldDescriptors) /
                                                                  sizeof(FailureEventFieldDescriptors[0]),
...
const nl::FieldDescriptor DownloadFailureEventFieldDescriptors[] = {
    ...
    { &Schema::Weave::Common::ProfileSpecificStatusCode::FieldSchema, offsetof(DownloadFailureEvent, primaryStatusCode),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 1), 3 },

    { &Schema::Weave::Common::ProfileSpecificStatusCode::FieldSchema, offsetof(DownloadFailureEvent, remoteStatusCode),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 1), 4 },
