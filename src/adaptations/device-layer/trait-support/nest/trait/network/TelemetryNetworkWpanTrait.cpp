...
const nl::SchemaFieldDescriptor NetworkWpanTopoMinimalEvent::FieldSchema = {
    .mNumFieldDescriptorElements =
        sizeof(NetworkWpanTopoMinimalEventFieldDescriptors) / sizeof(NetworkWpanTopoMinimalEventFieldDescriptors[0]),
...
const nl::FieldDescriptor NetworkWpanTopoFullEventFieldDescriptors[] = {
    ...
    { NULL,
      offsetof(NetworkWpanTopoFullEvent, deprecatedChildTable) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::ChildTableEntry_array, num),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeArray, 0), 7 },
    { &Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::ChildTableEntry::FieldSchema,
      offsetof(NetworkWpanTopoFullEvent, deprecatedChildTable) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::ChildTableEntry_array, buf),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 7 },

    { NULL,
      offsetof(NetworkWpanTopoFullEvent, deprecatedNeighborTable) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::NeighborTableEntry_array, num),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeArray, 0), 8 },
    { &Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::NeighborTableEntry::FieldSchema,
      offsetof(NetworkWpanTopoFullEvent, deprecatedNeighborTable) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::NeighborTableEntry_array, buf),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 8 },
...
const nl::SchemaFieldDescriptor NetworkWpanTopoFullEvent::FieldSchema                   = { .mNumFieldDescriptorElements =
                                                                              sizeof(NetworkWpanTopoFullEventFieldDescriptors) /
                                                                              sizeof(NetworkWpanTopoFullEventFieldDescriptors[0]),
...
const nl::FieldDescriptor WpanChannelmonStatsEventFieldDescriptors[] = {
    { NULL,
      offsetof(WpanChannelmonStatsEvent, channels) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::ChannelUtilization_array, num),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeArray, 0), 1 },
    { &Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::ChannelUtilization::FieldSchema,
      offsetof(WpanChannelmonStatsEvent, channels) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::ChannelUtilization_array, buf),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 1 },

    { NULL, offsetof(WpanChannelmonStatsEvent, samples), SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeUInt32, 0), 2 },

};

const nl::SchemaFieldDescriptor WpanChannelmonStatsEvent::FieldSchema                   = { .mNumFieldDescriptorElements =
                                                                              sizeof(WpanChannelmonStatsEventFieldDescriptors) /
                                                                              sizeof(WpanChannelmonStatsEventFieldDescriptors[0]),
...
const nl::FieldDescriptor WpanAntennaStatsEventFieldDescriptors[] = {
    { NULL,
      offsetof(WpanAntennaStatsEvent, antennaStats) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::PerAntennaStats_array, num),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeArray, 0), 1 },
    { &Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::PerAntennaStats::FieldSchema,
      offsetof(WpanAntennaStatsEvent, antennaStats) +
          offsetof(Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::PerAntennaStats_array, buf),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 1 },
...
const nl::SchemaFieldDescriptor NetworkWpanTopoParentRespEvent::FieldSchema = {
    .mNumFieldDescriptorElements =
        sizeof(NetworkWpanTopoParentRespEventFieldDescriptors) / sizeof(NetworkWpanTopoParentRespEventFieldDescriptors[0]),
...
const nl::SchemaFieldDescriptor TopoEntry::FieldSchema = { .mNumFieldDescriptorElements = sizeof(TopoEntryFieldDescriptors) /
                                                               sizeof(TopoEntryFieldDescriptors[0]),
                                                           .mFields = TopoEntryFieldDescriptors,
                                                           .mSize   = sizeof(TopoEntry) };

const nl::FieldDescriptor ChildTableEntryFieldDescriptors[] = {
    { &Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::TopoEntry::FieldSchema, offsetof(ChildTableEntry, topo),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 1 },
...
const nl::FieldDescriptor NeighborTableEntryFieldDescriptors[] = {
    { &Schema::Nest::Trait::Network::TelemetryNetworkWpanTrait::TopoEntry::FieldSchema, offsetof(NeighborTableEntry, topo),
      SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeStructure, 0), 1 },
