...
const nl::SchemaFieldDescriptor NetworkWiFiDeauthEvent::FieldSchema                   = { .mNumFieldDescriptorElements =
                                                                            sizeof(NetworkWiFiDeauthEventFieldDescriptors) /
                                                                            sizeof(NetworkWiFiDeauthEventFieldDescriptors[0]),
...
const nl::SchemaFieldDescriptor NetworkWiFiInvalidKeyEvent::FieldSchema = {
    .mNumFieldDescriptorElements =
        sizeof(NetworkWiFiInvalidKeyEventFieldDescriptors) / sizeof(NetworkWiFiInvalidKeyEventFieldDescriptors[0]),
...
const nl::FieldDescriptor NetworkWiFiConnectionStatusChangeEventFieldDescriptors[] = {
    { NULL, offsetof(NetworkWiFiConnectionStatusChangeEvent, isConnected), SET_TYPE_AND_FLAGS(nl::SerializedFieldTypeBoolean, 0),
      1 },

};

const nl::SchemaFieldDescriptor NetworkWiFiConnectionStatusChangeEvent::FieldSchema = {
    .mNumFieldDescriptorElements = sizeof(NetworkWiFiConnectionStatusChangeEventFieldDescriptors) /
        sizeof(NetworkWiFiConnectionStatusChangeEventFieldDescriptors[0]),
