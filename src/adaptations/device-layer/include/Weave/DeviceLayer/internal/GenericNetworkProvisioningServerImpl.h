...
class GenericNetworkProvisioningServerImpl : public ::nl::Weave::Profiles::NetworkProvisioning::NetworkProvisioningServer,
...
protected:
    ...
    WEAVE_ERROR ValidateThreadProvision(bool isUpdate, const DeviceNetworkInfo & netInfo, uint32_t & statusProfileId,
                                        uint16_t & statusCode);
    ...
    static void HandleConnectivityTestTimeOut(::nl::Weave::System::Layer * aLayer, void * aAppState,
...
template <class ImplClass> inline int16_t GenericNetworkProvisioningServerImpl<ImplClass>::GetCurrentOp() const
{
    return (mCurOp != NULL) ? mCurOpType : -1;
}

template <class ImplClass> inline bool GenericNetworkProvisioningServerImpl<ImplClass>::_ScanInProgress(void)
{
