 ...
 */
template <class ImplClass> class GenericConnectivityManagerImpl_BLE
{
public:
...
template <class ImplClass> inline bool GenericConnectivityManagerImpl_BLE<ImplClass>::_IsBLEAdvertisingEnabled(void)
{
    return BLEMgr().IsAdvertisingEnabled();
}

template <class ImplClass> inline WEAVE_ERROR GenericConnectivityManagerImpl_BLE<ImplClass>::_SetBLEAdvertisingEnabled(bool val)
{
    return BLEMgr().SetAdvertisingEnabled(val);
}

template <class ImplClass> inline bool GenericConnectivityManagerImpl_BLE<ImplClass>::_IsBLEFastAdvertisingEnabled(void)
{
    return BLEMgr().IsFastAdvertisingEnabled();
}

template <class ImplClass> inline WEAVE_ERROR GenericConnectivityManagerImpl_BLE<ImplClass>::_SetBLEFastAdvertisingEnabled(bool val)
{
    return BLEMgr().SetFastAdvertisingEnabled(val);
}

template <class ImplClass> inline bool GenericConnectivityManagerImpl_BLE<ImplClass>::_IsBLEAdvertising(void)
{
...
template <class ImplClass> inline uint16_t GenericConnectivityManagerImpl_BLE<ImplClass>::_NumBLEConnections(void)
{
