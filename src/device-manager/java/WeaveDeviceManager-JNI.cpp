...
static void HandleNetworkScanComplete(WeaveDeviceManager * deviceMgr, void * reqState, uint16_t netCount,
                                      const NetworkInfo * netInfoList);
static void HandleGetNetworksComplete(WeaveDeviceManager * deviceMgr, void * reqState, uint16_t netCount,
                                      const NetworkInfo * netInfoList);
static void HandleGetCameraAuthDataComplete(WeaveDeviceManager * deviceMgr, void * reqState, const char * macAddress,
                                            const char * signedPayload);
...
static void HandleGetFabricConfigComplete(WeaveDeviceManager * deviceMgr, void * reqState, const uint8_t * fabricConfig,
                                          uint32_t fabricConfigLen);
static void HandleDeviceEnumerationResponse(WeaveDeviceManager * deviceMgr, void * reqState,
...
static void HandlePairTokenComplete(WeaveDeviceManager * deviceMgr, void * reqState, const uint8_t * pairingTokenBundle,
                                    uint32_t pairingTokenBundleLen);
static void HandleUnpairTokenComplete(WeaveDeviceManager * deviceMgr, void * reqState);
static void HandleGetWirelessRegulatoryConfigComplete(WeaveDeviceManager * deviceMgr, void * reqState,
...
static void HandleGenericTraitUpdatableDataSinkError(void * context, void * reqState, WEAVE_ERROR deviceErr,
...
static WEAVE_ERROR J2N_ByteArrayFieldVal(JNIEnv * env, jobject obj, const char * fieldName, uint8_t *& outArray,
...
WEAVE_ERROR N2J_GenericArray(JNIEnv * env, uint32_t arrayLen, jclass arrayElemCls, jobjectArray & outArray,
                             GetElementFunct getElem);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginConnectBleNoAuth(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                          jint connObj, jboolean autoClose)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->ConnectBle(reinterpret_cast<BLE_CONNECTION_OBJECT>(connObj), (void *) "ConnectBle",
                                HandleSimpleOperationComplete, HandleError, (bool) autoClose);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginConnectBlePairingCode(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                               jint connObj, jboolean autoClose,
                                                                               jstring pairingCodeObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->ConnectBle(reinterpret_cast<BLE_CONNECTION_OBJECT>(connObj), pairingCodeStr, (void *) "ConnectBle",
                                HandleSimpleOperationComplete, HandleError, (bool) autoClose);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginConnectBleAccessToken(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                               jint connObj, jboolean autoClose,
                                                                               jbyteArray accessTokenObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->ConnectBle(reinterpret_cast<BLE_CONNECTION_OBJECT>(connObj), accessToken, accessTokenLen,
                                (void *) "ConnectBle", HandleSimpleOperationComplete, HandleError, (bool) autoClose);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginConnectDeviceNoAuth(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                             jlong deviceId, jstring deviceAddrObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->ConnectDevice((uint64_t) deviceId, deviceAddr, (void *) "ConnectDevice", HandleSimpleOperationComplete,
                                   HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginConnectDevicePairingCode(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                  jlong deviceId, jstring deviceAddrObj,
                                                                                  jstring pairingCodeObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    ...
    err = deviceMgr->ConnectDevice((uint64_t) deviceId, deviceAddr, pairingCodeStr, (void *) "ConnectDevice",
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginConnectDeviceAccessToken(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                  jlong deviceId, jstring deviceAddrObj,
                                                                                  jbyteArray accessTokenObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    ...
    err = deviceMgr->ConnectDevice((uint64_t) deviceId, deviceAddr, accessToken, accessTokenLen, (void *) "ConnectDevice",
                                   HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRendezvousDeviceNoAuth(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                jobject deviceCriteriaObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRendezvousDevicePairingCode(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                     jstring pairingCodeObj,
                                                                                     jobject deviceCriteriaObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    ...
    err = deviceMgr->RendezvousDevice(pairingCodeStr, deviceCriteria, (void *) "RendezvousDevice", HandleSimpleOperationComplete,
                                      HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRendezvousDeviceAccessToken(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                     jbyteArray accessTokenObj,
                                                                                     jobject deviceCriteriaObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    ...
    err = deviceMgr->RendezvousDevice(accessToken, accessTokenLen, deviceCriteria, (void *) "RendezvousDevice",
                                      HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRemotePassiveRendezvousNoAuth(
    JNIEnv * env, jobject self, jlong deviceMgrPtr, jstring rendezvousAddrObj, jint rendezvousTimeoutSec, jint inactivityTimeoutSec)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->RemotePassiveRendezvous(rendezvousAddr, rendezvousTimeoutSec, inactivityTimeoutSec,
                                             (void *) "RemotePassiveRendezvous", HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRemotePassiveRendezvousPairingCode(
    JNIEnv * env, jobject self, jlong deviceMgrPtr, jstring pairingCodeObj, jstring rendezvousAddrObj, jint rendezvousTimeoutSec,
    jint inactivityTimeoutSec)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    const char * pairingCodeStr    = NULL;
    ...
    err = deviceMgr->RemotePassiveRendezvous(rendezvousAddr, pairingCodeStr, rendezvousTimeoutSec, inactivityTimeoutSec,
                                             (void *) "RemotePassiveRendezvous", HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRemotePassiveRendezvousAccessToken(
    JNIEnv * env, jobject self, jlong deviceMgrPtr, jbyteArray accessTokenObj, jstring rendezvousAddrObj, jint rendezvousTimeoutSec,
    jint inactivityTimeoutSec)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err =
        deviceMgr->RemotePassiveRendezvous(rendezvousAddr, accessToken, accessTokenLen, rendezvousTimeoutSec, inactivityTimeoutSec,
                                           (void *) "RemotePassiveRendezvous", HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginScanNetworks(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                      jint networkType)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginAddNetwork(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                    jobject networkInfoObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginUpdateNetwork(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                       jobject networkInfoObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRemoveNetwork(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                       jlong networkId)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginGetCameraAuthData(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                           jstring nonce)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginEnableNetwork(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                       jlong networkId)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginDisableNetwork(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                        jlong networkId)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginTestNetworkConnectivity(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                 jlong networkId)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->TestNetworkConnectivity((uint32_t) networkId, (void *) "TestNetworkConnectivity",
                                             HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginSetRendezvousMode(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                           jint rendezvousFlags)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->SetRendezvousMode((uint16_t) rendezvousFlags, (void *) "SetRendezvousMode", HandleSimpleOperationComplete,
                                       HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginRegisterServicePairAccount(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                    jlong serviceId, jstring accountId,
                                                                                    jbyteArray serviceConfig,
                                                                                    jbyteArray pairingToken,
                                                                                    jbyteArray pairingInitData)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->RegisterServicePairAccount((uint64_t) serviceId, accountIdStr, serviceConfigBuf, serviceConfigLen,
                                                pairingTokenBuf, pairingTokenLen, pairingInitDataBuf, pairingInitDataLen,
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginUnregisterService(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                           jlong serviceId)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->UnregisterService((uint64_t) serviceId, (void *) "UnregisterService", HandleSimpleOperationComplete,
                                       HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginGetLastNetworkProvisioningResult(JNIEnv * env, jobject self,
                                                                                          jlong deviceMgrPtr)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->GetLastNetworkProvisioningResult((void *) "GetLastNetworkProvisioningResult", HandleSimpleOperationComplete,
                                                      HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginPingWithSize(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                      jint payloadSize)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_setRendezvousAddress(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                         jstring rendezvousAddrObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    const char * rendezvousAddrStr = NULL;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_setAutoReconnect(JNIEnv * env, jobject self, jlong deviceMgrPtr,
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_setRendezvousLinkLocal(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                           jboolean rendezvousLinkLocal)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_setConnectTimeout(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                      jint timeoutMS)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginJoinExistingFabric(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                            jbyteArray fabricConfig)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->JoinExistingFabric(fabricConfigBuf, fabricConfigLen, (void *) "JoinExistingFabric",
                                        HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginArmFailSafe(JNIEnv * env, jobject self, jlong deviceMgrPtr, jint armMode,
                                                                     jint failSafeToken)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->ArmFailSafe((uint8_t) armMode, (uint32_t) failSafeToken, (void *) "ArmFailSafe", HandleSimpleOperationComplete,
                                 HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginStartSystemTest(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                         jlong profileId, jlong testId)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->StartSystemTest((void *) "StartSystemTest", static_cast<uint32_t>(profileId), static_cast<uint32_t>(testId),
                                     HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginResetConfig(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                     jint resetFlags)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginEnableConnectionMonitor(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                 jint interval, jint timeout)
{
    ...
    err = deviceMgr->EnableConnectionMonitor((uint16_t) interval, (uint16_t) timeout, (void *) "EnableConnectionMonitor",
                                             HandleSimpleOperationComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginPairToken(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                   jbyteArray pairingToken)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->PairToken(pairingTokenBuf, static_cast<uint16_t>(pairingTokenLen), (void *) "PairToken",
                               HandlePairTokenComplete, HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginGetWirelessRegulatoryConfig(JNIEnv * env, jobject self, jlong deviceMgrPtr)
{
    ...
    err = deviceMgr->GetWirelessRegulatoryConfig((void *) "GetWirelessRegulatoryConfig", HandleGetWirelessRegulatoryConfigComplete,
                                                 HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_beginSetWirelessRegulatoryConfig(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                                     jobject regConfigObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->SetWirelessRegulatoryConfig(&regConfig, (void *) "SetWirelessRegulatoryConfig", HandleSimpleOperationComplete,
                                                 HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveDeviceManager_startDeviceEnumeration(JNIEnv * env, jobject self, jlong deviceMgrPtr,
                                                                           jobject deviceCriteriaObj)
{
    WEAVE_ERROR err                = WEAVE_NO_ERROR;
    WeaveDeviceManager * deviceMgr = (WeaveDeviceManager *) deviceMgrPtr;
    ...
    err = deviceMgr->StartDeviceEnumeration((void *) "StartDeviceEnumeration", deviceCriteria, HandleDeviceEnumerationResponse,
                                            HandleError);
...
void Java_nl_Weave_DeviceManager_WeaveStack_handleWriteConfirmation(JNIEnv * env, jobject self, jint connObj, jbyteArray svcIdObj,
                                                                    jbyteArray charIdObj, jboolean success)
{
#if CONFIG_NETWORK_LAYER_BLE
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
void Java_nl_Weave_DeviceManager_WeaveStack_handleIndicationReceived(JNIEnv * env, jobject self, jint connObj, jbyteArray svcIdObj,
                                                                     jbyteArray charIdObj, jbyteArray dataObj)
{
#if CONFIG_NETWORK_LAYER_BLE
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
void Java_nl_Weave_DeviceManager_WeaveStack_handleSubscribeComplete(JNIEnv * env, jobject self, jint connObj, jbyteArray svcIdObj,
                                                                    jbyteArray charIdObj, jboolean success)
{
#if CONFIG_NETWORK_LAYER_BLE
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
void Java_nl_Weave_DeviceManager_WeaveStack_handleUnsubscribeComplete(JNIEnv * env, jobject self, jint connObj, jbyteArray svcIdObj,
                                                                      jbyteArray charIdObj, jboolean success)
{
#if CONFIG_NETWORK_LAYER_BLE
    WEAVE_ERROR err = WEAVE_NO_ERROR;
...
void HandleGetCameraAuthDataComplete(WeaveDeviceManager * deviceMgr, void * reqState, const char * macAddress,
                                     const char * signedPayload)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
    JNIEnv * env;
...
void HandleGetFabricConfigComplete(WeaveDeviceManager * deviceMgr, void * reqState, const uint8_t * fabricConfig,
                                   uint32_t fabricConfigLen)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
    JNIEnv * env;
                                     ...
                                     IPAddress deviceAddr, InterfaceId deviceIntf)
{
    ...
    method = env->GetMethodID(deviceMgrCls, "onDeviceEnumerationResponse",
                              "(Lnl/Weave/DeviceManager/WeaveDeviceDescriptor;Ljava/lang/String; )V");
    VerifyOrExit(method != NULL, err = WDM_JNI_ERROR_METHOD_NOT_FOUND);
...
void HandlePairTokenComplete(WeaveDeviceManager * deviceMgr, void * reqState, const uint8_t * pairingTokenBundle,
                             uint32_t pairingTokenBundleLen)
{
    WEAVE_ERROR err = WEAVE_NO_ERROR;
    JNIEnv * env;
...
void HandleGetWirelessRegulatoryConfigComplete(WeaveDeviceManager * deviceMgr, void * reqState, const WirelessRegConfig * regConfig)
{
    ...
    method = env->GetMethodID(deviceMgrCls, "onGetWirelessRegulatoryConfigComplete",
                              "(Lnl/Weave/DeviceManager/WirelessRegulatoryConfig; )V");
    VerifyOrExit(method != NULL, err = WDM_JNI_ERROR_METHOD_NOT_FOUND);
...
WEAVE_ERROR N2J_NetworkInfo(JNIEnv * env, const NetworkInfo & inNetworkInfo, jobject & outNetworkInfo)
{
    ...
    makeMethod = env->GetStaticMethodID(
        sNetworkInfoCls, "Make", "(IJLjava/lang/String;III[BLjava/lang/String;[B[B[BSII)Lnl/Weave/DeviceManager/NetworkInfo;");
    VerifyOrExit(makeMethod != NULL, err = WDM_JNI_ERROR_METHOD_NOT_FOUND);

    env->ExceptionClear();
    outNetworkInfo = env->CallStaticObjectMethod(
        sNetworkInfoCls, makeMethod, (jint) inNetworkInfo.NetworkType, (jlong) inNetworkInfo.NetworkId, wifiSSID,
        (jint) inNetworkInfo.WiFiMode, (jint) inNetworkInfo.WiFiRole, (jint) inNetworkInfo.WiFiSecurityType, wifiKey, threadNetName,
        threadExtPANId, threadKey, threadPSKc, (jshort) inNetworkInfo.WirelessSignalStrength, (jint) inNetworkInfo.ThreadPANId,
...
WEAVE_ERROR N2J_DeviceDescriptor(JNIEnv * env, const WeaveDeviceDescriptor & inDeviceDesc, jobject & outDeviceDesc)
{
    ...
    {
        err = N2J_ByteArray(env, inDeviceDesc.Primary802154MACAddress, sizeof(inDeviceDesc.Primary802154MACAddress),
    ...
    {
        err = N2J_ByteArray(env, inDeviceDesc.PrimaryWiFiMACAddress, sizeof(inDeviceDesc.PrimaryWiFiMACAddress),
    ...
    constructor = env->GetMethodID(sWeaveDeviceDescriptorCls, "<init>",
                                   "(IIIIII[B[BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;JJLjava/lang/String;IIII)V");
    VerifyOrExit(constructor != NULL, err = WDM_JNI_ERROR_METHOD_NOT_FOUND);

    env->ExceptionClear();
    outDeviceDesc = (jthrowable) env->NewObject(
        sWeaveDeviceDescriptorCls, constructor, inDeviceDesc.VendorId, inDeviceDesc.ProductId, inDeviceDesc.ProductRevision,
        ...
        (jint) inDeviceDesc.PairingCompatibilityVersionMajor, (jint) inDeviceDesc.PairingCompatibilityVersionMinor,
...
WEAVE_ERROR N2J_WirelessRegulatoryConfig(JNIEnv * env, const WirelessRegConfig & inRegConfig, jobject & outRegConfig)
{
    ...
    err = N2J_GenericArray(env, inRegConfig.NumSupportedRegDomains, java_lang_String, supportedRegDomains,
                           [&inRegConfig](JNIEnv * _env, uint32_t index, jobject & outElem) -> WEAVE_ERROR {
                               ...
                               WEAVE_ERROR _err = N2J_NewStringUTF(_env, inRegConfig.SupportedRegDomains[index].Code,
                                                                   sizeof(WirelessRegDomain::Code), strElem);
                               outElem          = strElem;
                               return _err;
                           });
    SuccessOrExit(err);
    ...
    env->ExceptionClear();
    outRegConfig = (jthrowable) env->NewObject(sWirelessRegulatoryConfigCls, constructor, regDomain, (jint) inRegConfig.OpLocation,
                                               supportedRegDomains);
    VerifyOrExit(!env->ExceptionCheck(), err = WDM_JNI_ERROR_EXCEPTION_THROWN);
...
WEAVE_ERROR N2J_DeviceStatus(JNIEnv * env, DeviceStatus & devStatus, jthrowable & outEx)
{
    ...
    env->ExceptionClear();
    outEx = (jthrowable) env->NewObject(sWeaveDeviceExceptionCls, constructor, (jint) devStatus.StatusCode,
                                        (jint) devStatus.StatusProfileId, (jint) devStatus.SystemErrorCode, errStrObj);
    VerifyOrExit(!env->ExceptionCheck(), err = WDM_JNI_ERROR_EXCEPTION_THROWN);
...
#if WEAVE_CONFIG_DATA_MANAGEMENT_CLIENT_EXPERIMENTAL
void EngineEventCallback(void * const aAppState, SubscriptionEngine::EventID aEvent,
                         const SubscriptionEngine::InEventParam & aInParam, SubscriptionEngine::OutEventParam & aOutParam)
{
    switch (aEvent)
    {
...
jlong Java_nl_Weave_DataManagement_WdmClientImpl_newDataSink(JNIEnv * env, jobject self, jlong wdmClientPtr,
                                                             jobject resourceIdentifierObj, jlong profileId, jlong instanceId,
                                                             jstring path)
{
    WEAVE_ERROR err       = WEAVE_NO_ERROR;
    long res              = 0;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_init(JNIEnv * env, jobject self,
                                                                         jlong genericTraitUpdatableDataSinkPtr)
{
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_shutdown(JNIEnv * env, jobject self,
                                                                             jlong genericTraitUpdatableDataSinkPtr)
{
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_clear(JNIEnv * env, jobject self,
                                                                          jlong genericTraitUpdatableDataSinkPtr)
{
    GenericTraitUpdatableDataSink * pDataSink = (GenericTraitUpdatableDataSink *) genericTraitUpdatableDataSinkPtr;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_beginRefreshData(JNIEnv * env, jobject self,
                                                                                     jlong genericTraitUpdatableDataSinkPtr)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
    GenericTraitUpdatableDataSink * pDataSink = (GenericTraitUpdatableDataSink *) genericTraitUpdatableDataSinkPtr;
    ...
    pthread_mutex_lock(&sStackLock);
    err = pDataSink->RefreshData((void *) "RefreshData", HandleGenericTraitUpdatableDataSinkComplete,
                                 HandleGenericTraitUpdatableDataSinkError);
    pthread_mutex_unlock(&sStackLock);
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setInt(JNIEnv * env, jobject self,
                                                                           jlong genericTraitUpdatableDataSinkPtr, jstring path,
                                                                           jlong value, jboolean isConditional, jboolean isSigned)
{
    WEAVE_ERROR err       = WEAVE_NO_ERROR;
    const char * pPathStr = NULL;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setDouble(JNIEnv * env, jobject self,
                                                                              jlong genericTraitUpdatableDataSinkPtr, jstring path,
                                                                              jdouble value, jboolean isConditional)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
    const char * pPathStr                     = NULL;
    GenericTraitUpdatableDataSink * pDataSink = (GenericTraitUpdatableDataSink *) genericTraitUpdatableDataSinkPtr;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setBoolean(JNIEnv * env, jobject self,
                                                                               jlong genericTraitUpdatableDataSinkPtr, jstring path,
                                                                               jboolean value, jboolean isConditional)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
    const char * pPathStr                     = NULL;
    GenericTraitUpdatableDataSink * pDataSink = (GenericTraitUpdatableDataSink *) genericTraitUpdatableDataSinkPtr;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setString(JNIEnv * env, jobject self,
                                                                              jlong genericTraitUpdatableDataSinkPtr, jstring path,
                                                                              jstring value, jboolean isConditional)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
    const char * pPathStr                     = NULL;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setNull(JNIEnv * env, jobject self,
                                                                            jlong genericTraitUpdatableDataSinkPtr, jstring path,
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setBytes(JNIEnv * env, jobject self,
                                                                             jlong genericTraitUpdatableDataSinkPtr, jstring path,
                                                                             jbyteArray value, jboolean isConditional)
{
    WEAVE_ERROR err          = WEAVE_NO_ERROR;
    const char * pPathStr    = NULL;
    const uint8_t * pDataBuf = NULL;
...
void Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_setStringArray(JNIEnv * env, jobject self,
                                                                                   jlong genericTraitUpdatableDataSinkPtr,
                                                                                   jstring path, jobjectArray stringArray,
                                                                                   jboolean isConditional)
{
    WEAVE_ERROR err       = WEAVE_NO_ERROR;
    const char * pPathStr = NULL;
...
jlong Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getLong(JNIEnv * env, jobject self,
                                                                             jlong genericTraitUpdatableDataSinkPtr, jstring path)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
    uint64_t value                            = 0;
...
jdouble Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getDouble(JNIEnv * env, jobject self,
                                                                                 jlong genericTraitUpdatableDataSinkPtr,
                                                                                 jstring path)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
...
jboolean Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getBoolean(JNIEnv * env, jobject self,
                                                                                   jlong genericTraitUpdatableDataSinkPtr,
                                                                                   jstring path)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
...
jstring Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getString(JNIEnv * env, jobject self,
                                                                                 jlong genericTraitUpdatableDataSinkPtr,
                                                                                 jstring path)
{
    WEAVE_ERROR err       = WEAVE_NO_ERROR;
...
jbyteArray Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getBytes(JNIEnv * env, jobject self,
                                                                                   jlong genericTraitUpdatableDataSinkPtr,
                                                                                   jstring path)
{
    WEAVE_ERROR err       = WEAVE_NO_ERROR;
...
jobjectArray Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getStringArray(JNIEnv * env, jobject self,
                                                                                           jlong genericTraitUpdatableDataSinkPtr,
                                                                                           jstring path)
{
    WEAVE_ERROR err       = WEAVE_NO_ERROR;
...
jboolean Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_isNull(JNIEnv * env, jobject self,
                                                                               jlong genericTraitUpdatableDataSinkPtr, jstring path)
{
    WEAVE_ERROR err                           = WEAVE_NO_ERROR;
    GenericTraitUpdatableDataSink * pDataSink = (GenericTraitUpdatableDataSink *) genericTraitUpdatableDataSinkPtr;
...
NL_DLL_EXPORT jlong Java_nl_Weave_DataManagement_GenericTraitUpdatableDataSinkImpl_getVersion(
    JNIEnv * env, jobject self, jlong genericTraitUpdatableDataSinkPtr)
{
    GenericTraitUpdatableDataSink * pDataSink = (GenericTraitUpdatableDataSink *) genericTraitUpdatableDataSinkPtr;
    uint64_t version                          = 0;
