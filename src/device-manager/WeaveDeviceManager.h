...
typedef void (*IdentifyDeviceCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState,
                                            const DeviceDescription::WeaveDeviceDescriptor * devdesc);
typedef void (*DeviceEnumerationResponseFunct)(WeaveDeviceManager * deviceMgr, void * appReqState,
                                               const DeviceDescription::WeaveDeviceDescriptor * devdesc, IPAddress deviceAddr,
                                               InterfaceId deviceIntf);
typedef void (*NetworkScanCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState, uint16_t netCount,
                                         const NetworkInfo * netInfoList);
typedef void (*GetNetworksCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState, uint16_t netCount,
                                         const NetworkInfo * netInfoList);
...
typedef void (*GetFabricConfigCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState, const uint8_t * fabricConfig,
...
typedef void (*PairTokenCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState, const uint8_t * tokenPairingBundle,
                                       uint32_t tokenPairingBunldeLen);
typedef void (*UnpairTokenCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState);
typedef void (*GetCameraAuthDataCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState, const char * macAddress,
                                               const char * authData);
typedef void (*GetWirelessRegulatoryConfigCompleteFunct)(WeaveDeviceManager * deviceMgr, void * appReqState,
...
public:
    ...
    WEAVE_ERROR StartDeviceEnumeration(void * appReqState, const IdentifyDeviceCriteria & deviceCriteria,
    ...
    WEAVE_ERROR ConnectDevice(uint64_t deviceId, IPAddress deviceAddr, void * appReqState, CompleteFunct onComplete,
                              ErrorFunct onError);
    WEAVE_ERROR ConnectDevice(uint64_t deviceId, IPAddress deviceAddr, const char * pairingCode, void * appReqState,
    ...
    WEAVE_ERROR RendezvousDevice(const IdentifyDeviceCriteria & deviceCriteria, void * appReqState, CompleteFunct onComplete,
                                 ErrorFunct onError);
    WEAVE_ERROR RendezvousDevice(const char * pairingCode, const IdentifyDeviceCriteria & deviceCriteria, void * appReqState,
                                 CompleteFunct onComplete, ErrorFunct onError);
    WEAVE_ERROR RendezvousDevice(const uint8_t * accessToken, uint32_t accessTokenLen,
                                 const IdentifyDeviceCriteria & deviceCriteria, void * appReqState, CompleteFunct onComplete,
                                 ErrorFunct onError);
    WEAVE_ERROR PassiveRendezvousDevice(void * appReqState, CompleteFunct onComplete, ErrorFunct onError);
    WEAVE_ERROR PassiveRendezvousDevice(const char * pairingCode, void * appReqState, CompleteFunct onComplete, ErrorFunct onError,
                                        StartFunct onStart = NULL);
    WEAVE_ERROR PassiveRendezvousDevice(const uint8_t * accessToken, uint32_t accessTokenLen, void * appReqState,
                                        CompleteFunct onComplete, ErrorFunct onError);
#if CONFIG_NETWORK_LAYER_BLE
    WEAVE_ERROR ConnectBle(BLE_CONNECTION_OBJECT connObj, void * appReqState, CompleteFunct onComplete, ErrorFunct onError,
                           bool autoClose = true);
    WEAVE_ERROR ConnectBle(BLE_CONNECTION_OBJECT connObj, const char * pairingCode, void * appReqState, CompleteFunct onComplete,
                           ErrorFunct onError, bool autoClose = true);
    WEAVE_ERROR ConnectBle(BLE_CONNECTION_OBJECT connObj, const uint8_t * accessToken, uint32_t accessTokenLen, void * appReqState,
                           CompleteFunct onComplete, ErrorFunct onError, bool autoClose = true);
    ...
    WEAVE_ERROR RemotePassiveRendezvous(const IPAddress rendezvousDeviceAddr, const uint8_t * accessToken, uint32_t accessTokenLen,
    ...
    WEAVE_ERROR RemotePassiveRendezvous(const IPAddress rendezvousDeviceAddr, const uint16_t rendezvousTimeoutSec,
                                        const uint16_t inactivityTimeoutSec, void * appReqState, CompleteFunct onComplete,
                                        ErrorFunct onError);

    WEAVE_ERROR ReconnectDevice(void * appReqState, CompleteFunct onComplete, ErrorFunct onError);
    WEAVE_ERROR EnableConnectionMonitor(uint16_t interval, uint16_t timeout, void * appReqState, CompleteFunct onComplete,
                                        ErrorFunct onError);
    ...
    WEAVE_ERROR ScanNetworks(NetworkType networkType, void * appReqState, NetworkScanCompleteFunct onComplete, ErrorFunct onError);
    ...
    WEAVE_ERROR TestNetworkConnectivity(uint32_t networkId, void * appReqState, CompleteFunct onComplete, ErrorFunct onError);
    ...
    WEAVE_ERROR GetWirelessRegulatoryConfig(void * appReqState, GetWirelessRegulatoryConfigCompleteFunct onComplete,
                                            ErrorFunct onError);
    WEAVE_ERROR SetWirelessRegulatoryConfig(const WirelessRegConfig * regConfig, void * appReqState, CompleteFunct onComplete,
                                            ErrorFunct onError);
    ...
    WEAVE_ERROR JoinExistingFabric(const uint8_t * fabricConfig, uint32_t fabricConfigLen, void * appReqState,
                                   CompleteFunct onComplete, ErrorFunct onError);

    // ----- Service Provisioning -----
    WEAVE_ERROR RegisterServicePairAccount(uint64_t serviceId, const char * accountId, const uint8_t * serviceConfig,
                                           uint16_t serviceConfigLen, const uint8_t * pairingToken, uint16_t pairingTokenLen,
                                           const uint8_t * pairingInitData, uint16_t pairingInitDataLen, void * appReqState,
                                           CompleteFunct onComplete, ErrorFunct onError);
    WEAVE_ERROR UpdateService(uint64_t serviceId, const uint8_t * serviceConfig, uint16_t serviceConfigLen, void * appReqState,
                              CompleteFunct onComplete, ErrorFunct onError);
    WEAVE_ERROR UnregisterService(uint64_t serviceId, void * appReqState, CompleteFunct onComplete, ErrorFunct onError);

    // ----- Device Control -----
    WEAVE_ERROR ArmFailSafe(uint8_t armMode, uint32_t failSafeToken, void * appReqState, CompleteFunct onComplete,
                            ErrorFunct onError);
    WEAVE_ERROR DisarmFailSafe(void * appReqState, CompleteFunct onComplete, ErrorFunct onError);
    WEAVE_ERROR GetCameraAuthData(const char * nonce, void * appReqState, GetCameraAuthDataCompleteFunct onComplete,
                                  ErrorFunct onError);
    WEAVE_ERROR ResetConfig(uint16_t resetFlags, void * appReqState, CompleteFunct onComplete, ErrorFunct onError);

    WEAVE_ERROR StartSystemTest(void * appReqState, uint32_t profileId, uint32_t testId, CompleteFunct onComplete,
                                ErrorFunct onError);
    WEAVE_ERROR StopSystemTest(void * appReqState, CompleteFunct onComplete, ErrorFunct onError);

    // ---- Token Pairing ----
    WEAVE_ERROR PairToken(const uint8_t * pairingToken, uint32_t pairingTokenLen, void * appReqState,
    ...
    // ----- Node ID List Utils -----
    static WEAVE_ERROR AddNodeToList(uint64_t nodeId, uint64_t *& list, uint32_t & listLen, uint32_t & listMaxLen,
...
private:
    ...
    WEAVE_ERROR DoRemotePassiveRendezvous(const IPAddress rendezvousDeviceAddr, const uint16_t rendezvousTimeout,
                                          const uint16_t inactivityTimeout, void * appReqState, CompleteFunct onComplete,
                                          ErrorFunct onError);
...
#if CONFIG_NETWORK_LAYER_BLE
    WEAVE_ERROR InitiateBleConnection(BLE_CONNECTION_OBJECT connObj, void * appReqState, CompleteFunct onComplete,
                                      ErrorFunct onError, bool autoClose);
#endif // CONFIG_NETWORK_LAYER_BLE

    static WEAVE_ERROR FilterIdentifyResponse(IdentifyResponseMessage & respMsg, IdentifyDeviceCriteria criteria,
    ...
    static void HandleSessionError(WeaveSecurityManager * sm, WeaveConnection * con, void * appReqState, WEAVE_ERROR localErr,
    ...
    static void HandleReenableConnectionMonitorResponse(ExchangeContext * ec, const IPPacketInfo * pktInfo,
                                                        const WeaveMessageInfo * msgInfo, uint32_t profileId, uint8_t msgType,
                                                        PacketBuffer * payload);
    ...
    static void HandleNetworkProvisioningResponse(ExchangeContext * ec, const IPPacketInfo * pktInfo,
                                                  const WeaveMessageInfo * msgInfo, uint32_t profileId, uint8_t msgType,
                                                  PacketBuffer * payload);

    static void HandleGetCameraAuthDataResponseEntry(ExchangeContext * ec, const IPPacketInfo * pktInfo,
                                                     const WeaveMessageInfo * msgInfo, uint32_t profileId, uint8_t msgType,
                                                     PacketBuffer * payload);

    static void HandleServiceProvisioningResponse(ExchangeContext * ec, const IPPacketInfo * pktInfo,
                                                  const WeaveMessageInfo * msgInfo, uint32_t profileId, uint8_t msgType,
                                                  PacketBuffer * payload);

    static void HandleFabricProvisioningResponse(ExchangeContext * ec, const IPPacketInfo * pktInfo,
                                                 const WeaveMessageInfo * msgInfo, uint32_t profileId, uint8_t msgType,
                                                 PacketBuffer * payload);
    ...
    static void HandleRemotePassiveRendezvousComplete(ExchangeContext * ec, const IPPacketInfo * pktInfo,
                                                      const WeaveMessageInfo * msgInfo, uint32_t profileId, uint8_t msgType,
                                                      PacketBuffer * payload);
    ...
    static void HandleAssistingDeviceReconnectWithSessionCompleteEntry(WeaveDeviceManager * deviceMgr, void * appReqState);
    ...
    static void HandleRemoteConnectionComplete(ExchangeContext * ec, const IPPacketInfo * pktInfo, const WeaveMessageInfo * msgInfo,
                                               uint32_t profileId, uint8_t msgType, PacketBuffer * payload);
    static void HandleRemoteIdentifyResponse(ExchangeContext * ec, const IPPacketInfo * pktInfo, const WeaveMessageInfo * msgInfo,
                                             uint32_t profileId, uint8_t msgType, PacketBuffer * payload);
    ...
    WEAVE_ERROR GenerateNodeSignature(const Security::CASE::BeginSessionContext & msgCtx, const uint8_t * msgHash,
                                      uint8_t msgHashLen, TLVWriter & writer, uint64_t tag) __OVERRIDE;
    WEAVE_ERROR EncodeNodePayload(const Security::CASE::BeginSessionContext & msgCtx, uint8_t * payloadBuf, uint16_t payloadBufSize,
    ...
    WEAVE_ERROR HandleCertValidationResult(bool isInitiator, WEAVE_ERROR & validRes, Security::WeaveCertificateData * peerCert,
                                           uint64_t peerNodeId, Security::WeaveCertificateSet & certSet,
                                           Security::ValidationContext & validContext);
