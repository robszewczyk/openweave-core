...
static const JNILibraryMethod sLibraryMethods[] = {
    ...
    { "PasscodeEncryptionSupport", "encryptPasscode", "(IIJLjava/lang/String;[B[B[B)[B",
      (void *) PasscodeEncryptionSupport::encryptPasscode },
    { "PasscodeEncryptionSupport", "decryptPasscode", "([B[B[B[B)Ljava/lang/String;",
      (void *) PasscodeEncryptionSupport::decryptPasscode },
    { "PasscodeEncryptionSupport", "isSupportedPasscodeEncryptionConfig", "(I)Z",
      (void *) PasscodeEncryptionSupport::isSupportedPasscodeEncryptionConfig },
    { "PasscodeEncryptionSupport", "getEncryptedPasscodeConfig", "([B)I",
      (void *) PasscodeEncryptionSupport::getEncryptedPasscodeConfig },
    { "PasscodeEncryptionSupport", "getEncryptedPasscodeKeyId", "([B)I",
      (void *) PasscodeEncryptionSupport::getEncryptedPasscodeKeyId },
    { "PasscodeEncryptionSupport", "getEncryptedPasscodeNonce", "([B)J",
      (void *) PasscodeEncryptionSupport::getEncryptedPasscodeNonce },
    { "PasscodeEncryptionSupport", "getEncryptedPasscodeFingerprint", "([B)[B",
      (void *) PasscodeEncryptionSupport::getEncryptedPasscodeFingerprint },
    ...
    { "WeaveKeyExportClient", "generateKeyExportRequest", "(JIJ[B[B)[B",
      (void *) WeaveKeyExportClientNative::generateKeyExportRequest_Cert },
    { "WeaveKeyExportClient", "generateKeyExportRequest", "(JIJ[B)[B",
      (void *) WeaveKeyExportClientNative::generateKeyExportRequest_AccessToken },
    { "WeaveKeyExportClient", "processKeyExportResponse", "(JJ[B)[B",
      (void *) WeaveKeyExportClientNative::processKeyExportResponse },
    { "WeaveKeyExportClient", "processKeyExportReconfigure", "(J[B)V",
      (void *) WeaveKeyExportClientNative::processKeyExportReconfigure },
    { "WeaveKeyExportClient", "allowNestDevelopmentDevices", "(J)Z",
      (void *) WeaveKeyExportClientNative::allowNestDevelopmentDevices },
    { "WeaveKeyExportClient", "setAllowNestDevelopmentDevices", "(JZ)V",
      (void *) WeaveKeyExportClientNative::setAllowNestDevelopmentDevices },
    { "WeaveKeyExportClient", "allowSHA1DeviceCertificates", "(J)Z",
      (void *) WeaveKeyExportClientNative::allowSHA1DeviceCertificates },
    { "WeaveKeyExportClient", "setAllowSHA1DeviceCertificates", "(JZ)V",
      (void *) WeaveKeyExportClientNative::setAllowSHA1DeviceCertificates },

    // WeaveKeyExportSupport Methods
    { "WeaveKeyExportSupport", "simulateDeviceKeyExport", "([B[B[B[B)[Ljava/lang/Object;",
      (void *) WeaveKeyExportSupportNative::simulateDeviceKeyExport },
    ...
    { "PairingCodeSupport", "normalizePairingCode", "(Ljava/lang/String; )Ljava/lang/String;",
      (void *) PairingCodeSupport::normalizePairingCode },
