...
{
public:
    static jbyteArray encryptPasscode(JNIEnv * env, jclass cls, jint config, jint keyId, jlong nonce, jstring passcode,
                                      jbyteArray encKey, jbyteArray authKey, jbyteArray fingerprintKey);
    static jstring decryptPasscode(JNIEnv * env, jclass cls, jbyteArray encryptedPasscode, jbyteArray encKey, jbyteArray authKey,
...
public:
    ...
    static jbyteArray generateKeyExportRequest_Cert(JNIEnv * env, jclass cls, jlong nativeClientPtr, jint keyId,
                                                    jlong responderNodeId, jbyteArray clientCert, jbyteArray clientKey);
    static jbyteArray generateKeyExportRequest_AccessToken(JNIEnv * env, jclass cls, jlong nativeClientPtr, jint keyId,
                                                           jlong responderNodeId, jbyteArray accessToken);
    static jbyteArray processKeyExportResponse(JNIEnv * env, jclass cls, jlong nativeClientPtr, jlong responderNodeId,
...
{
public:
    static jobjectArray simulateDeviceKeyExport(JNIEnv * env, jclass cls, jbyteArray deviceCert, jbyteArray devicePrivKey,
                                                jbyteArray trustRootCert, jbyteArray keyExportReq);
};
